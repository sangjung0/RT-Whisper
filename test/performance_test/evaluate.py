...
PARAMETER = [
    ...
    },
    {
        ...
        "test_all": True,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-whisper-{MODEL_SIZE}.json",
        "language": "en",
    ...
    },
    {
        ...
        "test_all": True,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-whisper-{MODEL_SIZE}.json",
        "language": "en",
    ...
    ## libri clean
    {
        ...
        "test_all": True,
        "chunk_size": 48000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-3s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["simul_whisper"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 32000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-2s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["simul_whisper"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 16000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-1s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["simul_whisper"],
    },
    ...
    ## libri other
    {
        ...
        "test_all": True,
        "chunk_size": 48000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-3s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["simul_whisper"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 32000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-2s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["simul_whisper"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 16000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-1s-simul-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["simul_whisper"],
    },
    ...
    ## libri clean
    {
        ...
        "test_all": True,
        "chunk_size": 48000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-3s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["whisper_streaming"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 32000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-2s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["whisper_streaming"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 16000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_baseline-1s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["whisper_streaming"],
    },
    ...
    ## libri other
    {
        ...
        "test_all": True,
        "chunk_size": 48000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-3s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["whisper_streaming"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 32000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-2s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["whisper_streaming"],
    },
    {
        ...
        "test_all": True,
        "chunk_size": 16000,
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_baseline-1s-streaming-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["whisper_streaming"],
    },
    ...
    ## libri clean
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/3s/step2_3s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_evaluate-3s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["rt_whisper"],
    },
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/2s/step2_2s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_evaluate-2s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["rt_whisper"],
    },
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/1s/step2_1s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_clean/test_evaluate-1s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_clean,
        "test_models": ["rt_whisper"],
    },
    ...
    ## libri other
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/3s/step2_3s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_evaluate-3s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["rt_whisper"],
    },
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/2s/step2_2s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_evaluate-2s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["rt_whisper"],
    },
    {
        ...
        "hyperparameter": "/workspaces/dev/test/optimize/esic/hyperparameters/20250917/1s/step2_1s-96k-cpm/001_0_046.yaml",
        "output_path": f"/workspaces/dev/test/performance_test/output/libri_other/test_evaluate-1s-rt-whisper-{MODEL_SIZE}.json",
        "language": "en",
        "dataset": load_libri_other,
        "test_models": ["rt_whisper"],
    },
